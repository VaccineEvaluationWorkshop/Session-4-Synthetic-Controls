...
```{r}
d1 <- readRDS("./Data/ecuador_raw.rds") #imports file into R and saves as object 'd1'
```
...
```{r viewdata, include=TRUE}
    ...
    ds <- ds[ds$age_group %in% c('ec 2-23m A',  'ec 24-59m A'),]
```
...
```{r}
#saveRDS(glmer_results,'./Results/univariate_results.rds')
